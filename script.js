...
function tourn() {
  var x = document.getElementById("tournament_input").value;
  document.getElementById("tour_text").innerHTML = x;
}

function tur() {
  var x = document.getElementById("tournament");
  if (x.classList.contains("hide")) {
    x.classList.remove("hide");
  } 
  else {
...
function show_breakpoint() {
  var x = document.getElementById("add_breakpoint");
  if (x.classList.contains("hide")) {
    x.classList.remove("hide");
  } 
  else {
...
function show_setpoint() {
  var x = document.getElementById("add_setpoint");
  if (x.classList.contains("hide")) {
    x.classList.remove("hide");
  } 
  else {
...
function show_matchpoint() {
  var x = document.getElementById("add_matchpoint");
  if (x.classList.contains("hide")) {
    x.classList.remove("hide");
  } 
  else {
...
function show_tiebreak() {
  var x = document.getElementById("add_tie");
  if (x.classList.contains("hide")) {
    x.classList.remove("hide");
  } 
  else {
